      ...
      <Carousel interval={null} keyboard={false}>
        ...
        <Carousel.Item>
          ...
          <Carousel.Caption>
            <h3>
              {" "}
              Gibbs Sculpture Park, Kaipara Coast, Auckland Febuary 2019{" "}
            </h3>
          </Carousel.Caption>
        </Carousel.Item>
        <Carousel.Item>
          ...
          <Carousel.Caption>
            <h3>
              {" "}
              Northcote Point view of the Auckland Harbour Bridge, Northcote
              Point, Auckland June 2019{" "}
            </h3>
          </Carousel.Caption>
        </Carousel.Item>
        <Carousel.Item>
          ...
          <Carousel.Caption>
            <h3>
              {" "}
              Museum Forecourt view of Auckland CBD silhouette at Twilight,
              Auckland June 2019{" "}
            </h3>
          </Carousel.Caption>
        </Carousel.Item>
        <Carousel.Item>
          ...
          <Carousel.Caption>
            <h3>
              {" "}
              Mount Eden Twilight View of Auckland CBD, Auckland January 2020{" "}
            </h3>
          </Carousel.Caption>
        </Carousel.Item>
        <Carousel.Item>
